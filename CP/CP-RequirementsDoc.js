...
var item4=["DB DESCRIPTION AND DIAGRAMS", "If a user can be deleted, sometimes a 'blocked' field in the DB is better than actually deleting the record.", "Missing dataflow diagrams.", "Separate the data flows for the different functionality.", "Show us the data flow (steps) of this feature", "Missing database schema"];
var item5=["WIREFRAMES", "Missing wireframes for described features.", "Nice detail in the wireframes.", "Wireframes need more detail and labels.", "Add user roles to your frame labels to distinguish access.", "Where does user go at end of data flow? What page or view?", "Wireframes show features not listed in feature list.", "Figma link does not work.", "See my comments in your Figma files."];
