...
var item3=["FEATURE LIST", "Needs featured ordered by Must Have, Should Have, and Nice to Have", "Missing User Stories.", "Narrative Description: This should be a &quot;story&quot; of a person using your app, touching on the main features.", "User Stories: These should be short sentences that each describe one thing that type of user can do: &quot;A Lead Developer can assign a Developer to a Project&quot;", "User Stories: What are all the things a specific type of user can do with this feature?", "I don't see any described need for responsive on all devices. This could be Should Have or Nice to Have", "User registration is Must Have.", "Missing a Feature List", "As a movie goer, I should be able to..."];
...
var item5=["WIREFRAMES", "Missing wireframes for described features.", "Nice detail in the wireframes.", "Wireframes need more detail and labels.", "Where does user go at end of data flow? What page or view?", "Wireframes show features not listed in feature list."];
