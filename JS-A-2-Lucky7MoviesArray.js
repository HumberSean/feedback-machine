...
var item0=["FEEDBACK", "Great job!", "Good job. See rubric for more feedback.", "Put all JavaScript in the required external file (#1).", "You renamed your js file so I had to rename it back to match the HTML. Be sure to confirm your file submission in the folder before submitting."];
...
var item3=["RESULT MESSAGE", "Use your user input variable as the index to access your array... var movieChoice = myMovies[userInput - 1];", "Does not handle cancel (null).", "Does not handle 0.", "Popup should only show selected movie (#7).", "Movie number is off by one."];
...
var item5=["STRETCH GOAL", "And the extra challenge too! Nice work!", "You need a variable to hold the prompt value inside your while statement. Use this to end your while loop.", "Avoid while(true) and try to create “self-commenting” code with variables.", "Be explicit in your while statement: (while inputValue === true)", "No need to check for true after the while loop. Logically, we can't get there until that condition is reached by the while loop."];
