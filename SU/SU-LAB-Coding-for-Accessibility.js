...
var item2=["IMAGES", "Logo needs alt text: 'HTTP5221 logo'", "Change the name of logo image file to something meaningful", "The checkmark is a decorative image so its alt attribute should be an empty string.", "What information is the screenshot communicating that the text is not communicating? That is what the alt text needs to communicate.", "Very good descriptive text."];
