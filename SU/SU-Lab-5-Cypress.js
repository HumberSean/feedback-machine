...
var item2=["TEST TO FAIL", "Use describe blocks to group your Test to Pass and Test to Fail testing.", "Break up your specs into logical it() blocks. Use the Requirements/Specification as your guideline.", "Reset the page before testing to have a 'blank slate'.", "(#5) Check for background colour of red with .should(&quot;have.css&quot;, &quot;background-color&quot;, &quot;rgb(255, 0, 0)&quot;)", "You need to click submit before checking if the textbox background is red.", "(#6) Your Test to Fail should check that focus has been set on the input box when there is invalid input.", "focus() puts the focus there, but your test shouldn’t set the focus, it should see if focus has been set there. To check this use... .should(&quot;have.focus&quot;);", "Use the Cypress error messages to help you debug the issues.", "Do one test at a time until it works, then move on. If you get stuck, email me."];
