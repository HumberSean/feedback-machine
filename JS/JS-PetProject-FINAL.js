...
var item1=["FEATURES", "Nice use of your functions!", "A significant technical challenge - well done!", "Missing Should Have:", "Missing Must Have:", "alert() is not allowed. Use your DOM to message your users."];
...
var item3=["ERRORS", "You have an error on load. Keep your console open while you work to catch these errors."];
var item4=["PROFESSIONAL PRACTICE", "Add helpful comments to mark the sections of your code and significant logic pieces. I encourage you to do this first (&quot;pseudocode&quot;) before you start your work.", "Use comments in your HTML to mark the sections to make editing easier.", "Use comments in your CSS to mark sections and components to make navigation of the file easier.", "Use comments in your js to mark sections of your code and to explain your functions and code blocks."];
