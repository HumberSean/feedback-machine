...
var item1=["PROPERTIES", "Not all of these properties are meaningful to this object in a web application context (#3).", "The HTML file has not been updated to reflect your custom object.", "Does not have four properties and a method."];
var item2=["METHOD", "Your method (function) does not update the object, it only outputs the property values (#4).", "Your method should accept a parameter, rather than using a hard-coded value.", "The output (alert) should be in the function (# 4).", "The method does not update a property of the object."];
...
var item4=["STRETCH GOAL", "And the extra challenge too! Nice work!", "No need to separate extra challenge code, just give me the final version. Thank you!", "The default text should appear as the second parameter to the prompt (see Stretch Goal requirements)."];
