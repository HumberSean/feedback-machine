...
var item0=["FEEDBACK", "Great job!", "Good job. See rubric for more feedback.", "Critical Fail: 0 for any changes made to the provided HTML file.", "Please add your name to your file name when submitting.", "Please pay careful attention to requirements."];
...
var item4=["STRETCH GOAL: CHECK IT WITH REGEX", "And the extra challenge too! Nice work!!", "Your regex does not allow for uppercase and lowercase N (#4)", "Your regex allows for +9 characters. Use ^ and $ to limit a string. Try 'xN123456789' to see what I mean.", "Use a regular expression to check for the pattern."];
