...
var item2=["PART 2: OUTPUT", "Output should show full program name, not its shortcode (#2).", "Output is incorrect ().", "Output is incorrect. You did not use the provided p and span elements."];
var item3=["PART 3: VALIDATION", "Background should be red, not the font (#3).", "Focus should be in the first box with an error.", "Validate one field at a time.", "Validate the fields in the order that the user sees them.", "Missing validation for the dropdown.", "Background is required to be 'red' (255, 0, 0). Please pay careful attention to requirements(#3)."];
var item4=["STRETCH GOAL: CHECK IT WITH REGEX", "And the extra challenge too! Nice work!!", "Your regex allows for 9 digits. Use ^ and $ to limit a string.", "Your regex allows for 9 digits. Try 'xN12345678' to see what I mean.", "Your regex does not allow for uppercase and lowercase N (#4)"];
