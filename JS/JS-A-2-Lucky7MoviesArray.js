...
var item1=["VARIABLES", "Create 7 variables for your movies (#2).", "Giving your variables more neutral names will make them future-proof. E.g. movie1, movie2...", "Set valid flag variable to false. Your logic is sound, but semantically, we have not received valid data yet and should not proceed until valid switches from false to true."];
var item2=["ARRAY", "Use your variables in your array. No need to repeat the strings again. That's what the variables are for (#3).", "Use array.length as the running condition of your for loop."];
