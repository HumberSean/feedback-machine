...
var item5=["STRETCH GOAL", "And the extra challenge too! Nice work!", "You need a variable to hold the prompt value inside your while statement. Use this to end your while loop." , "Try to create “self-commenting” code with explanatory variable names: while( validInput === false )", "Be explicit in your while statement: (while inputValue === true)", "No need to check for true after the while loop. Logically, we can't get there until that condition is reached by the while loop.",  "You need a while loop for this, not a for loop.", "Avoid while(true) and try to create “self-commenting” code with explanatory variable names: while( validInput === false )"];
