...
var item0=["FEEDBACK", "Great job!", "Good job. See rubric for more feedback.", "Put all JavaScript in the required external file (#1).", "Please put your name in your filename when you submit. Thank you!", "Please put all submission files in one folder to zip and submit.", "We have not covered objects or arrays yet, so I would not expect you to use them. Please pay careful attention to requirements to ensure you are delivering the requested skills."];
...
var item2=["ASK FOR NAME", "Code does not handle invalid input (#3, #7).", "I would expect to enter my name with an uppercase letter, but your code says it's invalid.", "A switch would be the more appropriate structure given a &quot;set list&quot; of known values to check against."];
var item3=["GREET TEAM MEMBER", "Members should be greeted by their full name (#6).", "I love the use of variables in your switch for your team members!"];
